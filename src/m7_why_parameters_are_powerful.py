...
def run_test_even_better_draw_circles():
    ...
    centery = 200
    render = 1
    even_better_draw_circles(rad, centerx, centery, render)
...
def even_better_draw_circles(rad, centerx, centery, render):
